...
st.caption("Power-Law Time Decay · Conservative Calibration · Full Visuals")
...
fig.add_trace(go.Scatter(x=x_days[obs_net>0], y=obs_net[obs_net>0], mode='markers', marker=dict(color='red', size=10), name='Actual Data'))
